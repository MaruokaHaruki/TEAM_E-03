...
public class ScoreDraw : MonoBehaviour
{
    ...
    /// <summary>描画済みスコアA</summary>
    private int DrawDoneAScore;
    /// <summary>描画済みスコアB</summary>
    private int DrawDoneBScore;

    /// <summary>スコア設定済みフラグ</summary>
    private bool SetScoreFlag = false;

    private ResultController Result;

    /// <summary>勝利データ</summary>
    private int PlayerWinData;

    /// <summary>現在プレイヤーサイズ</summary>
    private Vector2 NowPlayersSize;

    /// <summary>次の行動までの時間</summary>
    private float NextMoveTime;

    /// <summary>開始時間</summary>
    [SerializeField, Header("開始時間")] private float StartTime = 2.0f;

    /// <summary>次の魚が落ちるまでの時間</summary>
    [SerializeField, Header("次の魚が落ちるまでの時間")] private float NextFishTime = 2.0f;

    /// <summary>大きさが変わる速度</summary>
    [SerializeField, Header("大きさが変わる速度")] private float SizeChangeSpeed = 0.1f;

    /// <summary>皿が吹っ飛ぶ力</summary>
    [SerializeField, Header("皿が吹っ飛ぶ力")] private float PlateUpPower = 100.0f;
    /// <summary>皿が飛ぶまでの時間</summary>
    [SerializeField, Header("皿が飛ぶまでの時間")] private float PlateUpTime = 0.5f;
