...
//     version 1.14.0
//     from Assets/Mizuno/PlayerABInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Mizuno/PlayerABInputActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @PlayerABInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @PlayerABInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""PlayerABInputActions"",
    ""maps"": [
        {
            ""name"": ""PlayerA"",
    ...
    ~@PlayerABInputActions()
    {
        UnityEngine.Debug.Assert(!m_PlayerA.enabled, "This will cause a leak and performance issues, PlayerABInputActions.PlayerA.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_PlayerB.enabled, "This will cause a leak and performance issues, PlayerABInputActions.PlayerB.Disable() has not been called.");
    }
    ...
    {
        private @PlayerABInputActions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerAActions(@PlayerABInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct PlayerBActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerBActions(@PlayerABInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
